...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*correct-course" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/correct-course/workflow.yaml">Course Correction Analysis</item>
    <item cmd="*create-architecture" workflow="{project-root}/_bmad/bmgd/workflows/3-technical/game-architecture/workflow.yaml">Produce a Scale Adaptive Game Architecture</item>
