...
export async function registerServiceAccountsRoutesV1(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.post(
    ...
    rotateServiceAccountSecret as any
  );
  ...
  fastify.post(
    ...
    reactivateServiceAccount as any
  );
