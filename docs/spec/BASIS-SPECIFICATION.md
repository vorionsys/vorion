...
Trust scores map to eight discrete tiers (T0-T7). Each tier unlocks additional capabilities.

| Tier | Name | Score Range | Default Capabilities |
|------|------|-------------|---------------------|
| T0 | Sandbox | 0-199 | Sandbox operations only; no external effects |
| T1 | Observed | 200-349 | Basic read operations; internal messaging |
| T2 | Provisional | 350-499 | Limited operations; proving trustworthiness |
| T3 | Monitored | 500-649 | Standard operations; limited external communication |
| T4 | Standard | 650-799 | Extended operations; external API calls |
| T5 | Trusted | 800-875 | Elevated operations; reduced oversight |
| T6 | Certified | 876-950 | Privileged operations; financial transactions |
| T7 | Autonomous | 951-1000 | Full autonomy within policy bounds |

**Tier Boundaries:**

```
TIER_SANDBOX_MAX = 199
TIER_OBSERVED_MAX = 349
TIER_PROVISIONAL_MAX = 499
TIER_MONITORED_MAX = 649
TIER_STANDARD_MAX = 799
TIER_TRUSTED_MAX = 875
TIER_CERTIFIED_MAX = 950
