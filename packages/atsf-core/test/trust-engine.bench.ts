...
describe("TrustEngine Performance Benchmarks", () => {
  ...
  describe("Core Operations", () => {
    bench(
      "initializeEntity - single entity",
      async () => {
    ...
    bench(
      "recordSignal - behavioral signal",
      async () => {
    ...
    bench(
      "getScore - with decay calculation",
      async () => {
    ...
    bench(
      "calculate - full score calculation",
      async () => {
  ...
  describe("Batch Operations", () => {
    ...
    bench(
      "recordSignal - 100 signals for single entity",
      async () => {
        const batchEngine = createTrustEngine();
  ...
  describe("Event Emission", () => {
    ...
    bench(
      "event emission with wildcard listener",
      async () => {
        const eventEngine = createTrustEngine();
  ...
  describe("Recovery Mechanics", () => {
    bench(
      "recovery calculation - accelerated recovery path",
      async () => {
  ...
  describe("Memory Usage", () => {
    bench(
      "memory efficiency - 1000 signals",
      async () => {
