...
export const CONTEXT_CEILINGS: Record<ContextType, number> = {
  local: 700,        // max T4 Standard
  enterprise: 900,   // max T5 Trusted
  sovereign: 1000,   // max T7 Autonomous
};
...
export const ROLE_GATE_MATRIX: Record<RoleLevel, Record<TrustTier, boolean>> = {
  'R-L0': { T0: true, T1: false, T2: false, T3: false, T4: false, T5: false, T6: false, T7: false },
  'R-L1': { T0: true, T1: true, T2: false, T3: false, T4: false, T5: false, T6: false, T7: false },
  'R-L2': { T0: true, T1: true, T2: true, T3: false, T4: false, T5: false, T6: false, T7: false },
  'R-L3': { T0: true, T1: true, T2: true, T3: true, T4: false, T5: false, T6: false, T7: false },
  'R-L4': { T0: true, T1: true, T2: true, T3: true, T4: true, T5: false, T6: false, T7: false },
  'R-L5': { T0: true, T1: true, T2: true, T3: true, T4: true, T5: true, T6: false, T7: false },
  'R-L6': { T0: true, T1: true, T2: true, T3: true, T4: true, T5: true, T6: true, T7: false },
  'R-L7': { T0: true, T1: true, T2: true, T3: true, T4: true, T5: true, T6: true, T7: true },
  'R-L8': { T0: true, T1: true, T2: true, T3: true, T4: true, T5: true, T6: true, T7: true },
};
...
// ============================================================================
// Q4: WEIGHT PRESETS (Hybrid: Spec + Deltas)
// @deprecated Use the 16-factor model from @vorionsys/basis.
//   - Factor weights: FACTOR_WEIGHTS in trust-engine/index.ts
//   - Factor presets: BASIS_CANONICAL_PRESETS in @vorionsys/council/trust/presets
//   - Factor thresholds: FACTOR_THRESHOLDS_BY_TIER in @vorionsys/basis
// ============================================================================

/** @deprecated Use FactorWeightConfig from @vorionsys/council/trust/presets for 16-factor weights. */
...
/** @deprecated Use BASIS_CANONICAL_PRESETS from @vorionsys/council/trust/presets for 16-factor presets. */
