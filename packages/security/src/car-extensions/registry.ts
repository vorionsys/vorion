 ...
 *
 * Manages registration, lookup, and validation of CAR ID extensions.
 * Extensions are identified by their unique extensionId and can also
 * be looked up by their shortcode for CAR ID string parsing.
 *
...
import { isValidExtensionId, isValidShortcode } from './car-string-extensions.js';

const logger = createLogger({ component: 'car-extension-registry' });

/**
 * Registry for CAR ID extensions
 *
