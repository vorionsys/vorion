 ...
 *   car: 'a3i.vorion.banquet-advisor:FHC-L3@1.2.0#gov,audit',
 *   publisher: 'vorion',
...
// =============================================================================
// DEPRECATED ALIASES (backwards compatibility from ACI → CAR rename)
// =============================================================================

/** @deprecated Use `CARExtension` instead. */
export type { CARExtension as ACIExtension } from './types.js';

/** @deprecated Use `CARExtensionMetadataSchema` instead. */
export { CARExtensionMetadataSchema as ACIExtensionMetadataSchema } from './types.js';

/** @deprecated Use `getCoreCAR` instead. */
export { getCoreCAR as getCoreACI } from './car-string-extensions.js';

/** @deprecated Use `buildCAR` instead. */
export { buildCAR as buildACI } from './car-string-extensions.js';

/** @deprecated Use `isValidCARWithExtensions` instead. */
export { isValidCARWithExtensions as isValidACIWithExtensions } from './car-string-extensions.js';

/** @deprecated Use `CARExtensionService` instead. */
export { CARExtensionService as ACIExtensionService } from './service.js';
...
export async function createFullExtensionService(
  ...
  const { createExtensionService: createService } = await import('./service.js');
  const { cognigateExtension: gov } = await import('./builtin-extensions/governance.js');
  const { monitoringExtension: mon } = await import('./builtin-extensions/monitoring.js');
  const { auditExtension: audit } = await import('./builtin-extensions/audit.js');
