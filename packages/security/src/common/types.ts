 ...
 * Trust level (T0-T7)
 *
 * Canonical 8-tier trust model:
 * - 0 (T0_SANDBOX): Isolated testing (0-199)
 * - 1 (T1_OBSERVED): Read-only, monitored (200-349)
 * - 2 (T2_PROVISIONAL): Basic operations, heavy supervision (350-499)
 * - 3 (T3_MONITORED): Standard operations, continuous monitoring (500-649)
 * - 4 (T4_STANDARD): External API access, policy-governed (650-799)
 * - 5 (T5_TRUSTED): Cross-agent communication (800-875)
 * - 6 (T6_CERTIFIED): Admin tasks, minimal oversight (876-950)
 * - 7 (T7_AUTONOMOUS): Full autonomy, self-governance (951-1000)
 */
...
export interface Entity {
  ...
  /** Trust level (0-7, maps to TrustBand T0-T7) */
