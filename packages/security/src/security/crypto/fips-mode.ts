...
export type FIPSKEMAlgorithm =
  (typeof FIPS_KEM_ALGORITHMS)[keyof typeof FIPS_KEM_ALGORITHMS];
...
export type FIPSPQSignatureAlgorithm =
  (typeof FIPS_PQ_SIGNATURE_ALGORITHMS)[keyof typeof FIPS_PQ_SIGNATURE_ALGORITHMS];

/**
 * ML-KEM public key sizes in bytes (FIPS 203)
 */
export const ML_KEM_PUBLIC_KEY_SIZES: Record<FIPSKEMAlgorithm, number> = {
  'ml-kem-512': 800,
  'ml-kem-768': 1184,
  'ml-kem-1024': 1568,
};
 ...
 */
export const ML_DSA_PUBLIC_KEY_SIZES: Record<FIPSPQSignatureAlgorithm, number> = {
  'ml-dsa-44': 1312,
  'ml-dsa-65': 1952,
  'ml-dsa-87': 2592,
};
