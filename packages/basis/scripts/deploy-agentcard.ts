...
async function main() {
  ...
  console.log(
    "2. Verify contract: npx hardhat verify --network mumbai",
    contractAddress,
  );
  console.log(
    "3. Mint AgentCard: npx hardhat run scripts/mint-agentcard.ts --network mumbai",
  );
  console.log(
    "4. Certify agent: npx hardhat run scripts/certify-agent.ts --network mumbai",
  );
}
