 ...
 * @module @vorion/car-extensions/builtin-extensions/monitoring
 * @license Apache-2.0
 */
...
const logger = createLogger({ component: 'car-ext-monitoring' });
 ...
 */
export const monitoringExtension: CARExtension = {
  extensionId: 'car-ext-monitoring-v1',
