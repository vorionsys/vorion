 ...
 *
 * Note: This is the internal Intent type which maintains backwards compatibility
 * while adding canonical fields from @vorion/contracts. The canonical names are:
 ...
 *             Use the adapters in src/intent/adapters.ts to convert between formats.
 */
export interface Intent {
  /** Unique intent identifier (canonical: intentId) */
  id: ID;
  /** Tenant this intent belongs to */
  tenantId: ID;
  /** Entity (agent) making the request (canonical: agentId) */
  entityId: ID;
  /** Goal/action to be performed (canonical: action) */
  goal: string;
  ...
  // These fields enable proper risk assessment and distributed tracing
  // ==========================================================================

  /** Correlation ID for end-to-end distributed tracing */
  correlationId?: ID | null;
  /** Action type category: read, write, delete, execute, communicate, transfer */
  actionType?: string | null;
  /** Resources this intent accesses/modifies (URN format) */
  resourceScope?: string[] | null;
  /** Data sensitivity level: PUBLIC, INTERNAL, CONFIDENTIAL, RESTRICTED */
  dataSensitivity?: string | null;
  /** Whether action can be undone: REVERSIBLE, PARTIALLY_REVERSIBLE, IRREVERSIBLE */
