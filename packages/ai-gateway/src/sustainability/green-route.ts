  ...
  > {
    ...
    if (stats.greenRoutedPercent < 50) {
      recommendations.push({
        ...
        implementation:
          "Set minPriority to HIGH to route more tasks through green models",
      });
    }
    ...
    if (!this.policy.offPeakOnly) {
      recommendations.push({
        ...
        description:
          "Schedule non-urgent tasks during off-peak hours (10pm-6am)",
    ...
    recommendations.push({
      ...
      description:
        "Use self-hosted Ollama models for more tasks to reduce data center emissions",
      potentialSavings: 0.2,
      implementation:
        "Route privacy-sensitive and batch tasks to local infrastructure",
    });
