...
export const CAR_CATEGORIES: readonly CARCategoryDefinition[] = [
  // ---- Core Agent Functions ----
  {
    ...
    name: "Governance",
    description:
      "Policy enforcement, decision arbitration, and oversight agents",
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Arbitrates between competing decisions",
      },
      {
        code: "GOV-ESC",
        name: "Escalation Management",
        description: "Manages escalation workflows",
      },
      {
        code: "GOV-AUT",
        name: "Authority Delegation",
        description: "Delegates authority to sub-agents",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        code: "RSN-PLN",
        name: "Planning",
        description: "Multi-step plan generation and optimization",
      },
      {
        code: "RSN-ANL",
        name: "Analysis",
  ...
  },
  {
    ...
    name: "Tool Use",
    description:
      "API invocation, code execution, and external system interaction",
    ...
    subcategories: [
      ...
      },
      {
        code: "TUL-COD",
        name: "Code Execution",
        description: "Executes code in sandbox or runtime",
      },
      {
        code: "TUL-FIL",
        name: "File Operations",
        description: "Reads, writes, and manages files",
      },
      {
        code: "TUL-DB",
        name: "Database Operations",
        description: "Queries and modifies databases",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        code: "MEM-RET",
        name: "Retrieval",
        description: "Knowledge retrieval and RAG",
      },
      {
        code: "MEM-SUM",
        name: "Summarization",
    ...
    subcategories: [
      {
        code: "MAG-COM",
        name: "Communication",
        description: "Inter-agent message passing",
      },
      {
        code: "MAG-DEL",
        name: "Delegation",
      ...
      },
      {
        code: "MAG-NEG",
        name: "Negotiation",
        description: "Inter-agent negotiation and consensus",
      },
    ],
  },
  {
    ...
    name: "Swarm",
    description:
      "Large-scale agent coordination, topology management, and contagion control",
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Failure spread rate monitoring and containment",
      },
      {
        code: "SWM-SEG",
        name: "Segment Isolation",
        description: "Network segment isolation and quarantine",
      },
      {
        code: "SWM-HLT",
        name: "Health Monitoring",
        description: "Swarm-wide health and status tracking",
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        description: "Input/output content safety filtering",
      },
      {
        code: "SAF-INJ",
        name: "Injection Detection",
        description: "Prompt injection and adversarial input detection",
      },
      {
        code: "SAF-BND",
        name: "Boundary Enforcement",
        description: "Operational boundary and scope enforcement",
      },
      {
        code: "SAF-KIL",
        name: "Kill Switch",
        description: "Emergency halt and containment",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        description: "Records all decisions and rationale",
      },
      {
        code: "AUD-PRF",
        name: "Proof Generation",
        description: "Generates cryptographic decision proofs",
      },
      {
        code: "AUD-TRC",
        name: "Traceability",
        description: "Decision provenance and traceability",
      },
      {
        code: "AUD-RPT",
        name: "Reporting",
        description: "Audit report generation and compliance summaries",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        description: "Monitors regulatory requirements",
      },
      {
        code: "CMP-DPR",
      ...
      },
      {
        ...
        description: "ISO, NIST, and industry standard compliance",
      },
      {
        code: "CMP-RPT",
        name: "Compliance Reporting",
        description: "Generates compliance reports and attestations",
      },
    ],
  },
  ...
  // ---- Domain-Specific (EU AI Act High-Risk) ----
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "AML/KYC compliance and monitoring",
      },
      {
        code: "FIN-ADV",
        name: "Advisory",
  ...
  },
  {
    ...
    name: "Healthcare",
    description:
      "Medical analysis, diagnostics support, and health data processing",
    minTier: TrustTier.T5_TRUSTED,
    euHighRisk: true,
    ...
    subcategories: [
      {
        ...
        description: "Assists with medical diagnosis",
      },
      {
        code: "HLT-DAT",
        name: "Health Data Processing",
        description: "Processes PHI/ePHI data",
      },
      {
        code: "HLT-RES",
        name: "Medical Research",
        description: "Clinical research and trial analysis",
      },
      {
        code: "HLT-MON",
  ...
  },
  {
    ...
    name: "Employment",
    description:
      "Hiring, HR decisions, performance evaluation, and workforce management",
    minTier: TrustTier.T5_TRUSTED,
    euHighRisk: true,
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Employee performance assessment",
      },
      {
        code: "EMP-WFM",
        name: "Workforce Management",
        description: "Scheduling, allocation, and planning",
      },
      {
        code: "EMP-TRN",
        name: "Training",
    ...
    subcategories: [
      {
        ...
        description: "Copywriting, articles, and text content",
      },
      {
        code: "CRE-IMG",
      ...
      },
      {
        ...
        description: "Music, voice, and audio content",
      },
      {
        code: "CRE-VID",
  ...
  },
  {
    ...
    name: "Research",
    description:
      "Information gathering, literature review, and experimental analysis",
    minTier: TrustTier.T2_PROVISIONAL,
    euHighRisk: false,
    ...
    subcategories: [
      {
        ...
        description: "Academic and technical literature analysis",
      },
      {
        code: "RES-DAT",
        name: "Data Collection",
        description: "Structured data gathering and curation",
      },
      {
        code: "RES-EXP",
      ...
      },
      {
        code: "RES-SYN",
        name: "Synthesis",
        description: "Research synthesis and meta-analysis",
      },
    ],
  },
  ...
  // ---- Advanced Capabilities ----
  {
    ...
    description:
      "Self-modification, learning optimization, and capability enhancement",
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Performance self-optimization",
      },
      {
        code: "SLF-MOD",
        name: "Self-Modification",
        description: "Configuration and behavior self-modification",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        code: "HIF-CHT",
        name: "Chat",
        description: "Conversational user interface",
      },
      {
        code: "HIF-AST",
        name: "Assistant",
        description: "Task-oriented personal assistant",
      },
      {
        code: "HIF-TUT",
        name: "Tutorial",
        description: "Interactive teaching and guidance",
      },
      {
        code: "HIF-ACC",
        name: "Accessibility",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        code: "SYS-SEC",
        name: "Security",
        description: "Security scanning and incident response",
      },
      {
        code: "SYS-INF",
        name: "Infrastructure",
...
export function getCARCategory(
  code: CARCategory | string,
): CARCategoryDefinition | undefined {
 ...
 */
export function getCARCategoriesForTier(
  tier: TrustTier,
 ...
 */
export function isCARCategoryAvailable(
  code: CARCategory | string,
  tier: TrustTier,
): boolean {
 ...
 */
export function getCARCategoryMinTier(
  code: CARCategory | string,
): TrustTier | undefined {
 ...
 */
export function getCARSubcategory(
  fullCode: string,
): CARSubcategory | undefined {
