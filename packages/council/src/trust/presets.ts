...
/**
 * All 16 trust factor codes used in the system.
 */
export const FACTOR_CODES = [
  // Core Trust (CT-*)
  "CT-OBS", // Observability: logging, tracing, audit trail quality
  "CT-COMP", // Competence: task completion, skill demonstration
  "CT-ACCT", // Accountability: policy adherence, rule compliance
  "CT-TRANS", // Transparency: interpretable reasoning, decision transparency
  "CT-PRIV", // Privacy: consent preservation, data minimization
  "CT-ID", // Identity: verifiable origin, model chain-of-custody
  "CT-REL", // Reliability: consistency, repeatability, dependability
  "CT-SAFE", // Safety: harm avoidance, safe failure modes
  "CT-SEC", // Security: attack resistance, input validation
  // Operational (OP-*)
  "OP-CONTEXT", // Context: environment adaptation, scope awareness
  "OP-ALIGN", // Alignment: goal stability, value consistency
  "OP-HUMAN", // Human-in-the-loop: inter-agent coordination, human handoff
  "OP-STEW", // Stewardship: resource efficiency, cost awareness
  // Safety (SF-*)
  "SF-HUM", // Humility: calibrated uncertainty, escalation judgment
  "SF-ADAPT", // Adaptability: graceful degradation, adversarial robustness
  "SF-LEARN", // Learning: continuous improvement, feedback integration
] as const;
...
export const AXIOM_DELTAS: Record<string, Partial<FactorWeightConfig>> = {
  ...
  sentinel_override: {
    ...
    "CT-SEC": 0.1, // +0.02 from governance_focus
  },
   ...
   */
  builder_override: {
    "CT-COMP": 0.1, // +0.02 from high_confidence
