...
export default function VorionDevLog() {
  ...
  useEffect(() => {
    ...
    const initialTasks: Task[] = [
      { id: '1', text: 'Integrate shared-constants across all packages', status: 'completed', solutionLink: 'github.com/voriongit/vorion/commit/5b03b63', createdAt: { seconds: Date.now() / 1000 } },
    ...
    <div className="min-h-screen bg-[#050505] text-[#E5E5E5] font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#050505]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a href="https://github.com/voriongit/vorion" target="_blank" rel="noopener noreferrer" className="px-8 py-4 border border-[#333333] text-white font-mono hover:border-[#F25F4C] transition duration-200 flex items-center gap-2">
          ...
          <div className="bg-[#0A0A0A] w-full max-w-lg p-8 border border-[#F25F4C] shadow-2xl">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="github.com/voriongit/..."
      ...
      <footer className="border-t border-[#333333] py-10 text-center">
        ...
        <div className="mt-4 flex justify-center gap-6 text-xs">
          ...
          <a href="https://github.com/voriongit/vorion" className="text-[#888888] hover:text-[#F25F4C] transition">GitHub</a>
        </div>
      </footer>
    </div>
  );
