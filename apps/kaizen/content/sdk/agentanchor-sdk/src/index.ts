/**
 * @vorionsys/sdk
 * Official SDK for the Vorion AI governance platform
 */
...
const DEFAULT_CONFIG: Partial<VorionConfig> = {
 ...
 */
export class Vorion {
  private config: Required<VorionConfig>;
  ...
  constructor(config: VorionConfig) {
    this.config = { ...DEFAULT_CONFIG, ...config } as Required<VorionConfig>;
...
class AgentsClient {
  constructor(private client: Vorion) {}
